...
const targetNetworksWithMainnet = targetNetworks.find((network: Chain) => network.id === mainnet.id)
  ? targetNetworks
  : [...targetNetworks, mainnet];

export const enabledChains = targetNetworksWithMainnet as unknown as readonly [Chain, ...Chain[]];
